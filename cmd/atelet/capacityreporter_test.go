...
func reporterFor(dir string, clients map[string]capacityClient, reportErr error) (*capacityReporter, *[]*ateapipb.SetWorkerCapacityRequest) {
	var got []*ateapipb.SetWorkerCapacityRequest
	r := &capacityReporter{
		ateomsDir: dir,
		...
		report: func(_ context.Context, in *ateapipb.SetWorkerCapacityRequest, _ ...grpc.CallOption) (*ateapipb.SetWorkerCapacityResponse, error) {
			got = append(got, in)
			return &ateapipb.SetWorkerCapacityResponse{}, reportErr
		},
	}
	return r, &got
}
