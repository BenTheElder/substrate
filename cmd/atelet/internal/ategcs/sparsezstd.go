...
// format from a plain zstd stream (older snapshots) by the first 8 bytes.
const sparseMagic = "ATESPS01"
...
//
//	magic[8] | totalSize:i64 | numExtents:i64 | (off:i64,len:i64)*numExtents | zstd(data...)
//
