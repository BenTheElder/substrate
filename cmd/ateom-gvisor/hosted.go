...
// dialer connects through the actor's gateway namespace.
func (h *hostedActor) dialer() atunnel.DialFunc {
	return h.network.Dialer()
}
...
func (s *AteomService) sandboxDialer(actorUID string) atunnel.DialFunc {
	return func(ctx context.Context, network, address string) (net.Conn, error) {
		...
		return hosted.dialer()(ctx, network, address)
	}
}
