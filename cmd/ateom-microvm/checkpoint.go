...
func (s *AteomService) terminateWorkload(ctx context.Context, actorUID string) error {
	...
	// with it, and reapplies the ruleset for the actors that remain -- which is
	// why it stands in for both the running-map delete and the bare
	// CleanupActorNetwork this used to do.
	//
