...
* Support for additional sandboxing technologies beyond gVisor. An initial microVM sandbox class (Kata Containers + Cloud Hypervisor) is now available; remaining work is hardening it and adding further flavors.
