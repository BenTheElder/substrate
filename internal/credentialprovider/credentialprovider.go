...
// what it returns. A nil AuthConfig with a nil error means the plugin has no
// credentials for this image.
func (p *plugin) provide(ctx context.Context, image string) (*credentialproviderv1.AuthConfig, error) {
	...
	var auth *credentialproviderv1.AuthConfig
	if key != "" {
