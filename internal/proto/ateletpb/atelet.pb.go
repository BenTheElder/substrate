...
type RunRequest struct {
	...
	RuntimeAssets          *RuntimeAssetsConfig   `protobuf:"bytes,9,opt,name=runtime_assets,json=runtimeAssets,proto3" json:"runtime_assets,omitempty"`
...
func (x *RunRequest) GetRuntimeAssets() *RuntimeAssetsConfig {
	if x != nil {
		return x.RuntimeAssets
	}
	return nil
}
...
func (x *RuntimeAsset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RuntimeAsset) ProtoMessage() {}

func (x *RuntimeAsset) ProtoReflect() protoreflect.Message {
	mi := &file_atelet_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RuntimeAsset.ProtoReflect.Descriptor instead.
func (*RuntimeAsset) Descriptor() ([]byte, []int) {
	return file_atelet_proto_rawDescGZIP(), []int{5}
}

func (x *RuntimeAsset) GetSha256Hash() string {
	if x != nil {
		return x.Sha256Hash
	}
	return ""
...
func (x *RuntimeAsset) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
type RuntimeAssetsConfig struct {
	state          protoimpl.MessageState   `protogen:"open.v1"`
	Runtime        string                   `protobuf:"bytes,1,opt,name=runtime,proto3" json:"runtime,omitempty"`                                                                         // "gvisor" | "microvm"
	Assets         map[string]*RuntimeAsset `protobuf:"bytes,2,rep,name=assets,proto3" json:"assets,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // name -> asset
	Authentication *AuthenticationConfig    `protobuf:"bytes,3,opt,name=authentication,proto3" json:"authentication,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *RuntimeAssetsConfig) Reset() {
	*x = RuntimeAssetsConfig{}
	mi := &file_atelet_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RuntimeAssetsConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RuntimeAssetsConfig) ProtoMessage() {}

func (x *RuntimeAssetsConfig) ProtoReflect() protoreflect.Message {
	mi := &file_atelet_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RuntimeAssetsConfig.ProtoReflect.Descriptor instead.
func (*RuntimeAssetsConfig) Descriptor() ([]byte, []int) {
	return file_atelet_proto_rawDescGZIP(), []int{6}
}

func (x *RuntimeAssetsConfig) GetRuntime() string {
	if x != nil {
		return x.Runtime
	}
	return ""
...
func (x *RuntimeAssetsConfig) GetAssets() map[string]*RuntimeAsset {
	if x != nil {
		return x.Assets
	}
	return nil
...
func (x *RuntimeAssetsConfig) GetAuthentication() *AuthenticationConfig {
	if x != nil {
		return x.Authentication
	}
	return nil
...
func (x *CheckpointRequest) GetRuntimeAssets() *RuntimeAssetsConfig {
	if x != nil {
		return x.RuntimeAssets
	}
	return nil
...
func (x *RestoreRequest) GetRuntimeAssets() *RuntimeAssetsConfig {
	if x != nil {
		return x.RuntimeAssets
	}
	return nil
...
var file_atelet_proto_goTypes = []any{
	...
	(*RuntimeAsset)(nil),            // 5: atelet.RuntimeAsset
	(*RuntimeAssetsConfig)(nil),     // 6: atelet.RuntimeAssetsConfig
	(*WorkloadSpec)(nil),            // 7: atelet.WorkloadSpec
	(*Container)(nil),               // 8: atelet.Container
	(*EnvEntry)(nil),                // 9: atelet.EnvEntry
	(*RunResponse)(nil),             // 10: atelet.RunResponse
...
var file_atelet_proto_depIdxs = []int32{
	...
	7,  // 1: atelet.RunRequest.spec:type_name -> atelet.WorkloadSpec
	6,  // 2: atelet.RunRequest.runtime_assets:type_name -> atelet.RuntimeAssetsConfig
	...
	15, // 7: atelet.RuntimeAssetsConfig.assets:type_name -> atelet.RuntimeAssetsConfig.AssetsEntry
	2,  // 8: atelet.RuntimeAssetsConfig.authentication:type_name -> atelet.AuthenticationConfig
	8,  // 9: atelet.WorkloadSpec.containers:type_name -> atelet.Container
	9,  // 10: atelet.Container.env:type_name -> atelet.EnvEntry
	4,  // 11: atelet.CheckpointRequest.runsc:type_name -> atelet.RunscConfig
	7,  // 12: atelet.CheckpointRequest.spec:type_name -> atelet.WorkloadSpec
	6,  // 13: atelet.CheckpointRequest.runtime_assets:type_name -> atelet.RuntimeAssetsConfig
	4,  // 14: atelet.RestoreRequest.runsc:type_name -> atelet.RunscConfig
	7,  // 15: atelet.RestoreRequest.spec:type_name -> atelet.WorkloadSpec
	6,  // 16: atelet.RestoreRequest.runtime_assets:type_name -> atelet.RuntimeAssetsConfig
	5,  // 17: atelet.RuntimeAssetsConfig.AssetsEntry.value:type_name -> atelet.RuntimeAsset
	0,  // 18: atelet.AteomHerder.Run:input_type -> atelet.RunRequest
	11, // 19: atelet.AteomHerder.Checkpoint:input_type -> atelet.CheckpointRequest
	13, // 20: atelet.AteomHerder.Restore:input_type -> atelet.RestoreRequest
	10, // 21: atelet.AteomHerder.Run:output_type -> atelet.RunResponse
	12, // 22: atelet.AteomHerder.Checkpoint:output_type -> atelet.CheckpointResponse
	14, // 23: atelet.AteomHerder.Restore:output_type -> atelet.RestoreResponse
