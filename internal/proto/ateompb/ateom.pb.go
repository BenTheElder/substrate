...
type GetCapacityResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// How many Actors this ateom can host at once, counting the ones it already
	// has. Zero is not "none": it means this ateom does not report a ceiling, and
	// the caller should leave whatever it already believes alone.
	ActorSlots    int32 `protobuf:"varint,1,opt,name=actor_slots,json=actorSlots,proto3" json:"actor_slots,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetCapacityResponse) GetActorSlots() int32 {
	if x != nil {
		return x.ActorSlots
	}
	return 0
...
const file_ateom_proto_rawDesc = "" +
	"\n" +
	"\vateom.proto\x12\x05ateom\"\x14\n" +
	"\x12GetCapacityRequest\"6\n" +
	"\x13GetCapacityResponse\x12\x1f\n" +
	"\vactor_slots\x18\x01 \x01(\x05R\n" +
	"actorSlots\"\xa4\x02\n" +
	...
	"#NO_SAMPLE_REASON_NOT_MEASURABLE_YET\x10\x022\xe2\x04\n" +
	"\x05Ateom\x12F\n" +
	...
	"\x11TerminateWorkload\x12\x1f.ateom.TerminateWorkloadRequest\x1a .ateom.TerminateWorkloadResponse\"\x00\x12F\n" +
	"\vGetCapacity\x12\x19.ateom.GetCapacityRequest\x1a\x1a.ateom.GetCapacityResponse\"\x00B=Z;github.com/agent-substrate/substrate/internal/proto/ateompbb\x06proto3"
...
var file_ateom_proto_goTypes = []any{
	...
	(*GetCapacityRequest)(nil),             // 4: ateom.GetCapacityRequest
	(*GetCapacityResponse)(nil),            // 5: ateom.GetCapacityResponse
	(*TerminateWorkloadRequest)(nil),       // 6: ateom.TerminateWorkloadRequest
	(*TerminateWorkloadResponse)(nil),      // 7: ateom.TerminateWorkloadResponse
	(*RunWorkloadRequest)(nil),             // 8: ateom.RunWorkloadRequest
	(*EgressGateway)(nil),                  // 9: ateom.EgressGateway
	(*WorkloadSpec)(nil),                   // 10: ateom.WorkloadSpec
	(*Container)(nil),                      // 11: ateom.Container
...
var file_ateom_proto_depIdxs = []int32{
	10, // 0: ateom.TerminateWorkloadRequest.spec:type_name -> ateom.WorkloadSpec
	10, // 1: ateom.RunWorkloadRequest.spec:type_name -> ateom.WorkloadSpec
	28, // 2: ateom.RunWorkloadRequest.runtime_asset_paths:type_name -> ateom.RunWorkloadRequest.RuntimeAssetPathsEntry
	9,  // 3: ateom.RunWorkloadRequest.egress_gateway:type_name -> ateom.EgressGateway
	11, // 4: ateom.WorkloadSpec.containers:type_name -> ateom.Container
	16, // 5: ateom.Container.readyz:type_name -> ateom.Readyz
	13, // 6: ateom.Container.durable_dir_volume_mounts:type_name -> ateom.DurableDirVolumeMount
	12, // 7: ateom.Container.csi_volume_mounts:type_name -> ateom.VolumeMount
	14, // 8: ateom.Container.system_info_volume_mounts:type_name -> ateom.SystemInfoVolumeMount
	15, // 9: ateom.Container.image_volume_mounts:type_name -> ateom.ImageVolumeMount
	17, // 10: ateom.Readyz.http_get:type_name -> ateom.HTTPGetAction
	10, // 11: ateom.CheckpointWorkloadRequest.spec:type_name -> ateom.WorkloadSpec
	29, // 12: ateom.CheckpointWorkloadRequest.runtime_asset_paths:type_name -> ateom.CheckpointWorkloadRequest.RuntimeAssetPathsEntry
	0,  // 13: ateom.CheckpointWorkloadRequest.scope:type_name -> ateom.SnapshotScope
	10, // 14: ateom.RestoreWorkloadRequest.spec:type_name -> ateom.WorkloadSpec
	30, // 15: ateom.RestoreWorkloadRequest.runtime_asset_paths:type_name -> ateom.RestoreWorkloadRequest.RuntimeAssetPathsEntry
	0,  // 16: ateom.RestoreWorkloadRequest.scope:type_name -> ateom.SnapshotScope
	9,  // 17: ateom.RestoreWorkloadRequest.egress_gateway:type_name -> ateom.EgressGateway
	...
	24, // 20: ateom.GetWorkloadStatsResponse.sample:type_name -> ateom.WorkloadStatsSample
	24, // 21: ateom.GetActiveWorkloadStatsResponse.samples:type_name -> ateom.WorkloadStatsSample
	3,  // 22: ateom.GetActiveWorkloadStatsResponse.no_sample_reason:type_name -> ateom.NoSampleReason
	8,  // 23: ateom.Ateom.RunWorkload:input_type -> ateom.RunWorkloadRequest
	19, // 24: ateom.Ateom.CheckpointWorkload:input_type -> ateom.CheckpointWorkloadRequest
	21, // 25: ateom.Ateom.RestoreWorkload:input_type -> ateom.RestoreWorkloadRequest
	23, // 26: ateom.Ateom.GetWorkloadStats:input_type -> ateom.GetWorkloadStatsRequest
	26, // 27: ateom.Ateom.GetActiveWorkloadStats:input_type -> ateom.GetActiveWorkloadStatsRequest
	6,  // 28: ateom.Ateom.TerminateWorkload:input_type -> ateom.TerminateWorkloadRequest
	4,  // 29: ateom.Ateom.GetCapacity:input_type -> ateom.GetCapacityRequest
	18, // 30: ateom.Ateom.RunWorkload:output_type -> ateom.RunWorkloadResponse
	20, // 31: ateom.Ateom.CheckpointWorkload:output_type -> ateom.CheckpointWorkloadResponse
	22, // 32: ateom.Ateom.RestoreWorkload:output_type -> ateom.RestoreWorkloadResponse
	25, // 33: ateom.Ateom.GetWorkloadStats:output_type -> ateom.GetWorkloadStatsResponse
	27, // 34: ateom.Ateom.GetActiveWorkloadStats:output_type -> ateom.GetActiveWorkloadStatsResponse
	7,  // 35: ateom.Ateom.TerminateWorkload:output_type -> ateom.TerminateWorkloadResponse
	5,  // 36: ateom.Ateom.GetCapacity:output_type -> ateom.GetCapacityResponse
...
func file_ateom_proto_init() {
	...
	file_ateom_proto_msgTypes[4].OneofWrappers = []any{}
