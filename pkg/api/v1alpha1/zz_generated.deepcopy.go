...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RuntimeAsset) DeepCopyInto(out *RuntimeAsset) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RuntimeAsset.
func (in *RuntimeAsset) DeepCopy() *RuntimeAsset {
	if in == nil {
		return nil
	}
	out := new(RuntimeAsset)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RuntimeConfig) DeepCopyInto(out *RuntimeConfig) {
	*out = *in
	if in.Assets != nil {
		...
		*out = make(map[string]RuntimeAsset, len(*in))
